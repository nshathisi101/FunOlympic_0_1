                        ...
                        <form method="post" action="ServletLogin2">
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="email" name="event" class="form-control" id="event" placeholder="">
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type='datetime-local' class="form-control" id="date"  value="01/01/2015 - 01/31/2015" />
                                </div>
