                        ...
                        <form method="post" action="ServletLogin2">
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-4">
                                    <label for="broadcast">Broadcast Name</label>
                                    <input type="text" name="broadcast" class="form-control" id="broadcast" placeholder="">
                                </div>
                                    <div class="mb-4">
                            ...
                            <div class="table-responsive mb-4">
                                <table id="ecommerce-product-customers" class="table table-bordered table-hover">
                                    ...
                                    <c:forEach var="broadcast" items="${broadcastInfo}">
                                        ...
                                        <tr>
                                            <td class="checkbox-column"> ${broadcast.id} </td>
                                            <td class="customer-name-1 fullName">${broadcast.broadcastName}</td>
                                            <td class="email">${broadcast.sport}</td>
                                            <td style="display: none"> ${broadcast.id} </td>
                                            <td class="">
                                                <ul class="table-controls">
                                                    <li>
                                                        <a  data-toggle="modal" data-target="#formInputModal" onclick="productDisplay(this)" data-placement="top" title="Edit">
                                                            <i class="flaticon-edit"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="warning confirm" id="${broadcast.id}" onclick="document.getElementById('delete_id').value=${broadcast.id}" data-toggle="tooltip" data-placement="top" title="Delete">
...
<script>
    function deleting(id_deleting){
        document.getElementById('deleting').submit();
        document.getElementById('delete_id').value=id_deleting;
    }
