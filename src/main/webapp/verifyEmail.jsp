...
<head>
    ...
    <title>Fun Olympic | Verification Email </title>
...
<form class="form-pass-recovery" method="post" action="ServletLogin2">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <label for="static-mask-code" class="">Verify Email</label>
            <input id="static-mask-code" type="text" name="codeVerify"  class="form-control mb-4" placeholder="Login" required >
            <button class="btn btn-lg btn-gradient-danger btn-block btn-rounded mb-4 mt-5" type="submit">Verify Email</button>
