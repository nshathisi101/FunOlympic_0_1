                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <ul class="table-controls">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);" class="warning confirm"  onclick="document.getElementById('delete_id').value='${event.id}'" data-toggle="tooltip" data-placement="top" title="Delete">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <p class="align-self-center mb-0"> Dave Tom </p>
                                            </div>
                                        </td>
                                        <td>Sprint</td>
                                        <td>Men's 100m</td>
                                        <td>
                                            <div class="d-flex">
                                                <div style="size: 1px">
                                                    <img alt="admin-profile" class="img-fluid " src="assets/img/medal2.png">
                                                </div>
                                            </div>
                                        </td>
                                        <td>2nd</td>
